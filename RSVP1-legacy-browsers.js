...
function welcomingRoutineBegin(snapshot) {
  return async function () {
    ...
    welcomingComponents.forEach( function(thisComponent) {
...
function practice_testRoutineBegin(snapshot) {
  return async function () {
    ...
    practice_testComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function noise_picRoutineBegin(snapshot) {
  return async function () {
    ...
    noise_picComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function practice_questionRoutineBegin(snapshot) {
  return async function () {
    ...
    practice_questionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function practice_mainRoutineBegin(snapshot) {
  return async function () {
    ...
    practice_mainComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function main_block_endRoutineBegin(snapshot) {
  return async function () {
    ...
    main_block_endComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function cross_2RoutineBegin(snapshot) {
  return async function () {
    ...
    cross_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function noise_pic_2RoutineBegin(snapshot) {
  return async function () {
    ...
    noise_pic_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
